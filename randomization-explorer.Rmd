...
library(shinybusy)     # Show the "busy" modal when running simulations
library(tidyverse)
...
get_simulation <- eventReactive(input$run_many_sims, {
  ...
  show_modal_spinner(color = "#009CAB", text = "SIMULATING...") # show the "busy" modal window
  ...
  remove_modal_spinner() # remove "busy" modal
